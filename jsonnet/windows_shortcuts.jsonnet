...

{
  ...
  rules: [
    ...
    k.rule('Home [-Chrome]',
           ...
           k.condition('unless', bundle.standard + ['^com\\.google\\.Chrome$'], file_paths.standard)),
    k.rule('Home (Ctrl) [-Chrome]',
           k.input('home', ['control']),
           k.outputKey('up_arrow', ['command']),
           k.condition('unless', bundle.standard + ['^com\\.google\\.Chrome$'], file_paths.standard)),
    k.rule('Home (Shift) [-Chrome]',
           k.input('home', ['shift']),
           k.outputKey('left_arrow', ['command', 'shift']),
           k.condition('unless', bundle.standard + ['^com\\.google\\.Chrome$'], file_paths.standard)),
    k.rule('Home (Ctrl+Shift) [-Chrome]',
    ...
    k.rule('End [-Chrome]',
           ...
           k.condition('unless', bundle.standard + ['^com\\.google\\.Chrome$'], file_paths.standard)),
    k.rule('End (Ctrl) [-Chrome]',
           k.input('end', ['control']),
           k.outputKey('down_arrow', ['command']),
           k.condition('unless', bundle.standard + ['^com\\.google\\.Chrome$'], file_paths.standard)),
    k.rule('End (Shift) [-Chrome]',
           k.input('end', ['shift']),
           k.outputKey('right_arrow', ['command', 'shift']),
           k.condition('unless', bundle.standard + ['^com\\.google\\.Chrome$'], file_paths.standard)),
    k.rule('End (Ctrl+Shift) [-Chrome]',
